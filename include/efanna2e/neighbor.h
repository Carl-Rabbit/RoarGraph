...
class NeighborMaxsumPriorityQueue {
   public:
    NeighborMaxsumPriorityQueue() : _size(0), _cur(0), _threshold(0) {}

    NeighborMaxsumPriorityQueue(float threshold, int capacity_factor) : _size(0), _cur(0), _threshold(threshold), _capacity_factor(capacity_factor), _data(0) {}
